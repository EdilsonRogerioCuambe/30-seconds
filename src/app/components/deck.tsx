      ...
      {!isCodeVerified && (
        <div className="flex flex-col items-center justify-center rounded-lg">
          <p className="text-2xl font-extrabold uppercase text-purple-400 text-center mb-2">
            Insira o código de segurança para iniciar o jogo
          </p>
          <input
          ...
          <button
            type="button"
            onClick={verifyCode}
            className="bg-green-400 hover:bg-green-600 text-black font-extrabold uppercase px-4 py-2 rounded transition-all duration-300 ease-in-out"
          >
            Verificar
          </button>
        </div>
        ...
        <>
          ...
          <div className="mt-4">
            <button
              type="button"
              onClick={
                isPlaying ? pauseGame : isPaused ? continueGame : startGame
              }
              className={`${
                isPlaying
